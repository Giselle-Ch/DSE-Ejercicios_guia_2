...
namespace MvcPelicula.Controllers
{
    public class PeliculasController : Controller
    {
        ...
        public ActionResult Index(string buscarString, string generoPelicula, string precioPelicula)
        {
            ...
            //var PrecioQry = from price in db.Peliculas
            //                orderby price.Precio
            //                select price.Precio;

            GeneroList.AddRange(GeneroQry.Distinct());
            ViewBag.generoPelicula = new SelectList(GeneroList);
            ...
            {
                decimal precioP = decimal.Parse(precioPelicula);
                peliculas = peliculas.Where(y => y.Precio.Equals(precioP));
                //peliculas = peliculas.Where(y => y.Precio.Equals(precioPelicula));
            }
